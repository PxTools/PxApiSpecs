...
{ 
    ...
    public class RelatedLink : IEquatable<RelatedLink>
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((RelatedLink)obj);
        }

        /// <summary>
        /// Returns true if RelatedLink instances are equal
        /// </summary>
        /// <param name="other">Instance of RelatedLink to be compared</param>
        /// <returns>Boolean</returns>
        ...
        public static bool operator ==(RelatedLink left, RelatedLink right)
        {
